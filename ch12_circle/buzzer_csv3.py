"""Вариант 4: Чтение данных csv в виде СЛОВАРЯ, преобразование в своем словаре и вывод на экран"""
import csv, os
...
flights2 = {}
for k, v in flights.items():    #метод items возвращает значения словаря по-одному
    flights2[convert2ampm(k)] = v.title()   #в каждой итерации ключ(к) преобразуется в 12ти час, а затем исп-ся в качестве ключа в новом словаре. Значение v преобразуется в регистр заголовка, а затем присваивается преобразованному ключу(к)
